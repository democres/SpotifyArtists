...
class APIService {
    ...
    func getAlbums(id: String) -> Single<Data> {
        var request = URLRequest(url:URL(string:"https://api.spotify.com/v1/artists/\(id)/albums?market=CO&limit=3")!)
